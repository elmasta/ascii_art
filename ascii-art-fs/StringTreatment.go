...
func StrTreatment(jFlag string, cFlag string, sList [][]string, lineSize []int, toFile bool, f *os.File, width int, startInd int, ind int, count int, word string, data []string) {
